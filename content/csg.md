...
{{ image(path="cnb.webp", desc="Cannonball", link="https://youtu.be/ey00mPkhMCs?t=679") }}
...
{{ gallery_start() }}
{{ image(path="lbt.webp", desc="Lib", link="https://youtu.be/3ju2179PNC8?t=132") }}
...
{{ image(path="cwl.webp", desc="Cartwheel", link="") }}
