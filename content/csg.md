...
Snapshot collection of 138 cheer stunting skills (30 still missing).
...
{{ image(path="kbl.jpg", desc="Kat Abela", link="https://www.youtube.com/@katabela") }}
{{ image(path="cdl.jpg", desc="Caylee Odle", link="https://www.youtube.com/@Its.ccaylee") }}
{{ image(path="jnn.jpg", desc="Bonde Johnson", link="https://www.youtube.com/@bonde.johnson") }}
{{ image(path="bsk.jpg", desc="Daniel Buyeske", link="https://www.youtube.com/@danielbuyeske") }}
...
{{ gallery_start() }}
{{ image(path="lbt.jpg", desc="Lib", link="https://youtu.be/3ju2179PNC8?t=132") }}
...
{{ image(path="trh.jpg", desc="Torch", link="https://youtu.be/Be-Sv_3gx5A?t=485") }}
...
{{ image(path="nhp.jpg", desc="No handspring up", link="https://www.youtube.com/shorts/EHGxbOI7mZQ") }}
